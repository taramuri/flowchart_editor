...
function App() {
  ...
  const runTests = async (limit) => {
    setShowTestModal(true);
    setTestOutput('Починаю тестування...');
    setTestProgress(0);
    setIsTesting(true);
  ...
  // Функція переривання тестування
  const cancelTesting = () => {
              ...
              <div className="space-y-6">
                ...
                <div className="border rounded p-4 bg-gray-50">
                  ...
                  <div className="flex items-center mb-4">
                    <label className="mr-2 text-sm">Максимальна кількість операцій (K):</label>
                    <input
                      type="number"
                  ...
                  <div className="text-sm text-gray-600 bg-yellow-50 p-2 rounded flex items-start">
                    <div className="text-yellow-500 mt-0.5 mr-2 flex-shrink-0">⚠️</div>
                    <div>
                      Для недетермінованих блок-схем (де два потоки можуть одночасно змінювати спільні змінні), 
                      система перевірить різні можливі варіанти виконання з не більше ніж K операціями.
                    </div>
                  </div>
                </div>
